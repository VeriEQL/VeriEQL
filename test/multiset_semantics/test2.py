    ...
    Not(
        Or(
            Implies(
                And(
                    r1, r2,
                    EQUALITY_FACTS1, NULL_OR_NOT_FACTS,
                ),
                And(
                    ...
                    Implies(
                        Not(DELETED(t1)),
                        And(
                            # emp_name(t1) == emp_name(t3),
                            NULL(t1, attr_emp_name) == NULL(t3, attr_emp_name),
                            Implies(
                                And(Not(NULL(t1, attr_emp_name)), Not(NULL(t3, attr_emp_name))),
                                emp_name(t1) == emp_name(t3),
                            ),
                        ),
                    ),
            ...
            Implies(
                And(
                    r1, r2,
                    EQUALITY_FACTS2, NULL_OR_NOT_FACTS,
                ),
                And(
                    DELETED(t1) == DELETED(t3),
                    Implies(
